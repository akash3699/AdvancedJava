...
public class UserController {
	...
	@PostMapping("/login")
	public String processLoginForm(@RequestParam String em, @RequestParam String pass, Model map,HttpSession hs,RedirectAttributes flashMap) {
		System.out.println("in process login form " + em + " " + pass);
		try {
			// invoke Dao's method
			Vendor u = dao.authenticateUser(em, pass);
